    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: 6) {
                ...
                Text(viewModel.restaurants[Int(viewModel.selectedRestaurantIndex)].todayMenu!.main)
            ...
            HStack(spacing: 6) {
                Text("사이드 메뉴")
                    ...
                    .foregroundColor(Color("primary.orange"))
                    .frame(width: 80, alignment: .leading)
                Text(viewModel.restaurants[Int(viewModel.selectedRestaurantIndex)].todayMenu!.side)
                    .font(.pretendard(.regular, size: 14))
                    .foregroundColor(Color("dark_1"))
                    .lineSpacing(15)
                Spacer()
            ...
            HStack(spacing: 6) {
                Text("후식")
                    ...
                    .foregroundColor(Color("primary.orange"))
                    .frame(width: 80, alignment: .leading)
                Text(viewModel.restaurants[Int(viewModel.selectedRestaurantIndex)].todayMenu!.dessert)
                    .font(.pretendard(.regular, size: 14))
                    .foregroundColor(Color("dark_1"))
                Spacer()
            }
